### Arrow: a combined shape to construct a arrow.

Create: svg.add_shape(Shape::Arrow(Arrow::new(start_point, end_point, handle_base, head_base, head_height)))

![](../../../../../../showcase/arrow/arrow1_show.svg)

#### Arrow showcase: create a basic arrow.
...
![](../../../../../../showcase/arrow/arrow1.svg)

#### Arrow showcase: create multiple arrows from a point to all degree direction.
